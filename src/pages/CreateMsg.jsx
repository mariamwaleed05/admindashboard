      ...
      {showConfirm && (
        <div className="modal-overlay">
          <div className="modal-container">
            ...
            <h2>Are you sure?</h2>
            <p>Delete this message permanently? This cannot be undone.</p>
            <div className="modal-actions">
              <button onClick={() => setShowConfirm(false)} className="btn-modal-cancel">Cancel</button>
              <button onClick={confirmDelete} className="btn-modal-delete">Delete Message</button>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="dashboard-wrapper">
          ...
          <div className="stats-row">
            <div className="stat-card">
              ...
              <div className="stat-content"><h3>Total Messages</h3><p>{messages.length}</p></div>
            </div>
            <div className="stat-card">
          ...
          {isComposeVisible && (
            <div className="compose-panel">
              ...
              <div className="form-group">
                <label>Message</label>
                <textarea className="form-input" rows="4" value={newMsg.Message} onChange={(e) => setNewMsg({...newMsg, Message: e.target.value})}></textarea>
              </div>
              <div className="form-actions">
                <button className="btn-send" onClick={handleCreate}>
                  Send <span className="icon-spacer"><Icons.Send /></span>
                </button>
              </div>
            </div>
          )}
